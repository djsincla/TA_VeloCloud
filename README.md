...
- 7/16/21 Updated version numbers... 1.0.x is original Python2 version of code. 1.1.x is Python3 with userid and password. 1.2.x is Python3 with security token. 
